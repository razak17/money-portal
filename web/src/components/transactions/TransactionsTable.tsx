        ...
        <chakra.table borderBottom="1px solid black" width="100%">
          <chakra.thead borderWidth="1px" borderRadius="md">
            <chakra.tr textAlign="left" role="row">
              <chakra.th width="117px" padding="0.5em"></chakra.th>
              <chakra.th width="140px" padding="0.5em">
                Amount
              </chakra.th>
              <chakra.th width="220px" padding="0.5em">
                Type
              </chakra.th>
              <chakra.th width="275px" padding="0.5em">
                Memo
              </chakra.th>
              <chakra.th width="250px" padding="0.5em">
                Date
              </chakra.th>
            </chakra.tr>
          </chakra.thead>
